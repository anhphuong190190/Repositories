...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println("Sort:" + sortByIndex((String) testcases[i][0], (Integer) testcases[i][1], (Integer) testcases[i][2]));
        // }
        // System.out.println(Arrays.toString(bubble_sort(new String[] { "B", "e", "d", "a", "c", "f", "s", "k", "g", "p", "h", "a", "s" })));
        //
