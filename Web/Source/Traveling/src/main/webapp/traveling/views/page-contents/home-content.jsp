<section class="slider">
  <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
    <div class="carousel-inner">
      <div class="item"> <img data-src="../images/slider/image_1920x1000.jpg" alt="first slide" src="../images/slider/image_1920x1000.jpg">
        <div class="container">
      ...
      <div class="item"> <img data-src="../images/slider/image_1920x1000.jpg" alt="second slide" src="../images/slider/image_1920x1000.jpg">
        <div class="container">
          <div class="carousel-caption text-left">
      ...
      <div class="item active"> <img data-src="../images/slider/image_1920x1000.jpg" alt="third slide" src="../images/slider/image_1920x1000.jpg">
        <div class="container">
          <div class="carousel-caption text-left">
...
<section class="main__middle__container homepage">
  ...
  <div class="row grey-info-block text-left">
    <div class="container">
      <div class="col-md-6">
        ...
        <p class="small-paragraph">Cras iaculis ultricies nulla.</p>
        <img src="../images/content__images/image_460x190.jpg" alt="pic" class="img-rounded img-responsive" id="picture">
  ...
  <div class="row text-left nothing line__bg testimonials">
    <div class="container">
      ...
      <img src="../images/content__images/image_940x210.jpg" class="img-responsive img-rounded">
